		...
		<td>
			<table class="kb-subtable awardbox-top">
				<tr class="kb-table-row-odd">
					<td class="kb-table-imgcell"><img src="{$corp_portrait}" alt="{$name}" height="64" width="64" /></td>
					<td class="kb-table-imgcell"><img src="{$award_img}" alt="award" height="64" width="64" /></td>
				</tr>
			</table>
